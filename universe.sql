...
INSERT INTO public.moon VALUES (1, 'Moon', 'The Moon is Earth"s only natural satellite.', false, 384.40, 3);
INSERT INTO public.moon VALUES (2, 'Io', 'Io, or Jupiter I, is the innermost and second-smallest of the four Galilean moons of the planet Jupiter.', false, 421.70, 5);
INSERT INTO public.moon VALUES (3, 'Europa', 'Europa, or Jupiter II, is the smallest of the four Galilean moons orbiting Jupiter, and the sixth-closest to the planet of all the 95 known moons of Jupiter.', false, 670.90, 5);
INSERT INTO public.moon VALUES (4, 'Ganymede', 'Ganymede, or Jupiter III, is the largest and most massive natural satellite of Jupiter as well as the largest in the Solar System, being a planetary-mass moon.', false, 1070.40, 5);
INSERT INTO public.moon VALUES (5, 'Callisto', 'Callisto, or Jupiter IV, is the second-largest moon of Jupiter, after Ganymede.', false, 1880.00, 5);
INSERT INTO public.moon VALUES (6, 'Titan', 'Titan is the largest moon of Saturn and the second-largest in the Solar System, larger than any of the dwarf planets of the Solar System.', false, 1200.00, 6);
INSERT INTO public.moon VALUES (7, 'Rhea', 'Rhea is the second-largest moon of Saturn and the ninth-largest moon in the Solar System, with a surface area that is comparable to the area of Australia.', false, 527.11, 6);
INSERT INTO public.moon VALUES (8, 'Iapetus', 'Iapetus is a moon of Saturn. With an estimated diameter of 1,469 km, it is the third-largest moon of Saturn and the eleventh-largest in the Solar System.', false, 3560.82, 6);
INSERT INTO public.moon VALUES (9, 'Dione', 'Dione, also designated Saturn IV, is the fourth-largest moon of Saturn. Its trailing hemisphere is marked by large ice cliffs called chasmata and is also darkened compared to the leading hemisphere.', false, 377.40, 6);
INSERT INTO public.moon VALUES (10, 'Tethys', 'Tethys, or Saturn III, is a fifth largest moon of Saturn about 1,060 km (660 mi) across.', false, 294.62, 6);
INSERT INTO public.moon VALUES (11, 'Titania', 'Titania, also designated Uranus III, is the largest of the moons of Uranus and the eighth largest moon in the Solar System at a diameter of 1,578 kilometres (981 mi), with a surface area comparable to that of Australia.', false, 435.91, 7);
INSERT INTO public.moon VALUES (12, 'Oberon', 'Oberon, also designated Uranus IV, is the outermost major moon of the planet Uranus. It is the second-largest, with a surface area that is comparable to the area of Australia, and second most massive of the Uranian moons, and the tenth most massive moon in the Solar System.', false, 583.52, 7);
INSERT INTO public.moon VALUES (13, 'Umbriel', 'Umbriel consists mainly of ice with a substantial fraction of rock, and may be differentiated into a rocky core and an icy mantle', false, 266.00, 7);
INSERT INTO public.moon VALUES (14, 'Ariel', 'Ariel is the fourth-largest moon of Uranus. Ariel orbits and rotates in the equatorial plane of Uranus, which is almost perpendicular to the orbit of Uranus and so has an extreme seasonal cycle.', false, 190.90, 7);
INSERT INTO public.moon VALUES (15, 'Miranda', 'Miranda, also designated Uranus V, is the smallest and innermost of Uranus"s five round satellites.', false, 129.39, 7);
INSERT INTO public.moon VALUES (16, 'Triton', 'Triton is the largest natural satellite of the planet Neptune, and was the first Neptunian moon to be discovered.', false, 354.76, 8);
INSERT INTO public.moon VALUES (17, 'Proteus', 'Proteus, also known as Neptune VIII, is the second-largest Neptunian moon, and Neptune"s largest inner satellite.', false, 117.65, 8);
INSERT INTO public.moon VALUES (18, 'Phobos', 'Phobos (systematic designation: Mars I) is the innermost and larger of the two natural satellites of Mars, the other being Deimos.', false, 6.00, 4);
INSERT INTO public.moon VALUES (19, 'Deimos', 'Deimos (systematic designation: Mars II) is the smaller and outer of the two natural satellites of Mars.', false, 23.46, 4);
INSERT INTO public.moon VALUES (20, 'Charon', 'Charon known as (134340) Pluto I, is the largest of the five known natural satellites of the dwarf planet Pluto.', false, 19.57, 9);
...
SELECT pg_catalog.setval('public.planet_types_by_composition_planet_types_by_composition_id_seq', 5, true);
